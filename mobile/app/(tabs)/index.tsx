...
export default function DashboardScreen() {
  const { auth, hasTab } = useAuth();
  const router = useRouter();

  // Dashboard is the landing screen, but roles without dashboard access (e.g. Cashier, or a custom
...
function DashboardContent({ auth, router }: { auth: ReturnType<typeof useAuth>["auth"]; router: ReturnType<typeof useRouter> }) {
